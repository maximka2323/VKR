...
public:
	...
	void getUS(int n)
	{
	x = StrToFloat(fmIn->StringGrid5->Cells[1][n]);
	y = StrToFloat(fmIn->StringGrid5->Cells[2][n]);
	R.v(0) = StrToFloat(fmIn->StringGrid5->Cells[3][n]);
	R.v(1) = StrToFloat(fmIn->StringGrid5->Cells[4][n]);
	R.v(2) = StrToFloat(fmIn->StringGrid5->Cells[5][n]);
	C[0] = StrToInt(fmIn->StringGrid5->Cells[6][n]);
	C[1] = StrToInt(fmIn->StringGrid5->Cells[7][n]);
	C[2] = StrToInt(fmIn->StringGrid5->Cells[8][n]);
	}
...
public:
  ...
  void SetTmtx()
   ...
   void getEL(int n)
	{
	U1 = StrToInt(fmIn->StringGrid6->Cells[1][n]);
	U2 = StrToInt(fmIn->StringGrid6->Cells[2][n]);
	E = StrToFloat(fmIn->StringGrid6->Cells[3][n]);
	S = StrToFloat(fmIn->StringGrid6->Cells[4][n]);
	I = StrToFloat(fmIn->StringGrid6->Cells[5][n]);
	W = StrToFloat(fmIn->StringGrid6->Cells[6][n]);
	ST = StrToFloat(fmIn->StringGrid6->Cells[7][n]);
	p = StrToFloat(fmIn->StringGrid6->Cells[8][n]);
	q = StrToFloat(fmIn->StringGrid6->Cells[9][n]);
	Alfa = StrToFloat(fmIn->StringGrid6->Cells[10][n]);
	T = StrToFloat(fmIn->StringGrid6->Cells[11][n]);
	}

	...
	int lnu,lne;
	  ...
	  lne = StrToInt(Edit2->Text);
	   if(lnu>1&&lne>0&&(lnu-lne)<2)
	   {
		  ...
		  fmIn->StringGrid4->Cells[0][0] = nu;
		  fmIn->StringGrid4->Cells[1][0] = ne;
...
void __fastcall TMasterIn::BuUSClick(TObject *Sender)
{
	...
	double j;
	 fmIn->StringGrid5->Cells[0][i-1] = i;
	 j =  StrToFloat(Edit3->Text);
	 fmIn->StringGrid5->Cells[1][i-1] = j ;
	 j =  StrToFloat(Edit4->Text);
	 fmIn->StringGrid5->Cells[2][i-1] = j;
	 j =  StrToFloat(Edit5->Text);
	 fmIn->StringGrid5->Cells[3][i-1] = j;
	 j =  StrToFloat(Edit6->Text);
	 fmIn->StringGrid5->Cells[4][i-1] = j;
	 j =  StrToFloat(Edit7->Text);
	 fmIn->StringGrid5->Cells[5][i-1] = j;
	 j =  StrToFloat(Edit8->Text);
	 fmIn->StringGrid5->Cells[6][i-1] = j;
	 j =  StrToFloat(Edit9->Text);
	 fmIn->StringGrid5->Cells[7][i-1] = j;
	 j =  StrToFloat(Edit10->Text);
	 fmIn->StringGrid5->Cells[8][i-1] = j;
...
void __fastcall TMasterIn::BuELClick(TObject *Sender)
{
	...
	double j;
	 ...
	 fmIn->StringGrid6->Cells[0][i-1] = i;
	 j =  StrToFloat(Edit11->Text);
	 fmIn->StringGrid6->Cells[1][i-1] = j;
	 j =  StrToFloat(Edit12->Text);
	 fmIn->StringGrid6->Cells[2][i-1] = j;
	 j =  StrToFloat(Edit13->Text);
	 fmIn->StringGrid6->Cells[3][i-1] = j;
	 j =  StrToFloat(Edit14->Text);
	 fmIn->StringGrid6->Cells[4][i-1] = j;
	 j =  StrToFloat(Edit19->Text);
	 fmIn->StringGrid6->Cells[5][i-1] = j;
	 j =  StrToFloat(Edit15->Text);
	 fmIn->StringGrid6->Cells[6][i-1] = j;
	 j =  StrToFloat(siEdit->Text);
	 fmIn->StringGrid6->Cells[7][i-1] = FloatToStrF(j,ffFixed,8,2);
	 j =  StrToFloat(pEdit->Text);
	 fmIn->StringGrid6->Cells[8][i-1] = FloatToStrF(j,ffFixed,8,2);
	 j =  StrToFloat(qEdit->Text);
	 fmIn->StringGrid6->Cells[9][i-1] = j;
	 j =  StrToFloat(aEdit->Text);
	 fmIn->StringGrid6->Cells[10][i-1] = j;
	 j =  StrToFloat(tEdit->Text);
	 fmIn->StringGrid6->Cells[11][i-1] = j;
